...
const tarifUpdate = () => {
  ...
  const handleFormSubmit = async (values, currentUserToken) => {
    ...
    axios
      .put(
        `https://p3l-10683.et.r.appspot.com/api/v1/tarif/updateTarif/${id}`,
        {
  ...
  const fetchInitialValues = async (id, currentUserToken) => {
    ...
    try {
      const response = await axios.get(
        `https://p3l-10683.et.r.appspot.com/api/v1/tarif/getTarifByID/${id}`,
        config
      );
...
useEffect(() => {
    const fetchInitialValuesSeason = async (currentUserToken) => {
        ...
        axios
          .get("https://p3l-10683.et.r.appspot.com/api/v1/season/getAllSeason", config)
          .then((response) => {
  ...
  useEffect(() => {
    const fetchInitialValuesKamar = async (currentUserToken) => {
        ...
        axios
          .get("https://p3l-10683.et.r.appspot.com/api/v1/kamar/getAllKamar", config)
          .then((response) => {
